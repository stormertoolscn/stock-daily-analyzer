...
### v1.19.0 (2026-08-11)
*   **K 线页高度自适应**：图表弹性填满窗口，移除固定 640px 下限，底部不再留大片空白。
### v1.18.0 (2026-08-11)
...
### v1.16.0 (2026-08-10)
*   **左侧版头布局**：版头移到左侧抽屉（默认收起、悬停左边缘拉出、可钉住），导航右侧一键切换左侧/顶部版头；ABi 主题下左侧版头保持深蓝白字橙线。
### v1.15.0 (2026-08-10)
*   **ABi研究 主题精简**：蓝+橘配色仅用于版头（深蓝渐变 + 白字 + 橙色底线），移除内容区各页面的深蓝 hero 大块，恢复浅色简洁布局。
### v1.14.0 (2026-08-10)
